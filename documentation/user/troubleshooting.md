...
the user presets for that run and keeps only the built-in presets
(`DefaultStarboard180`, `DefaultPort180`, `Default360`, `windy`). Preset save
operations write a fresh `presets.json`.
