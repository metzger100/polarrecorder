...
| R15  | `stability_window`            | reject     | `reject_warming_up`, `reject_unstable`                                    | Retained buffer plus current sample must span `stability_window_seconds`, default 15 s; filled ranges must stay below TWA 20 deg, TWS 10 kt, STW 4 kt defaults.                        | P-TWA/TWS/STW                 |
