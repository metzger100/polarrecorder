...
- **How do AvNav editable parameters work, and where are Polar Recorder's runtime settings defined?** -> [avnav/editable-parameters.md](avnav/editable-parameters.md), [user/configuration.md](user/configuration.md)
